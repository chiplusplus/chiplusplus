...
🚀 A Data Platform Engineer building scalable analytics systems (5B+ daily events)
☁️ AWS-heavy background (EMR, Redshift, Airflow, CDK) with a strong focus on CI/CD, validation & reliability
🔨 Currently building Access-IQ — an end-to-end analytics platform exploring ingestion, transformation, orchestration, data quality, and reporting
